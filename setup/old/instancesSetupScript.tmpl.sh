...
sudo docker run --restart always --name deer-vision-db -e POSTGRES_PASSWORD=$dbPassword -v /home/ubuntu/data/db/:/var/lib/postgresql/data -p 5432:5432 -d postgres:14.5
...
echo -e "#"'!'"/bin/bash\n\n" \
  ...
  "sudo docker exec -t deer-vision-db pg_dump -U postgres > /home/ubuntu/deervision_dump.sql\n" \
