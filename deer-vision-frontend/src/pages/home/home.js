                    ...
                    <div className="game-info-container">
                        ...
                        <Description>
                            ...
                            <div className="game-description">
                                <div className={"p-game-description"}>During your journey, you will be confronted with a variety of original and challenging puzzles. You will be required to form ingenious systems by building blocks having different abilities, such as deflecting and merging laser beams, turning and pushing other blocks.</div>
                                <div className={"p-game-description"}>Unleash your creativity and problem-solving skills to progress through the game, unravel the mysteries of your surroundings and unlock new information as you delve deeper into the unknown.</div>
                                <div className={"p-game-description"}>The laser puzzles are interspersed with sliding puzzles that require strategic moves to solve.</div>
                            </div>

                            <p>Story</p>
                            <div className="game-description">
                                <div className={"p-game-description"}>In 2075, a space probe saw a strange platform floating in space near Jupiter. The government has decided to finance a space mission to send you on this platform to elucidate the mystery.</div>
                                <div className={"p-game-description"}>Your mission is to discover why this platform exists and who built it.</div>
                            </div>
                        </Description>
                    ...
                    <Description>
                        ...
                        <div className="game-description">
                            <ul className={"game-list"}>
                                ...
                                <li>20 puzzle achievements that extend the game experience.</li>
